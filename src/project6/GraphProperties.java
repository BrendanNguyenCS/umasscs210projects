...
public class GraphProperties {
     ...
     */
    public RedBlackBST<Integer, Integer> degreeDistribution() { return st; }

    /**
     * Getter for {@link #avgDegree}
     * @return the average degree of the graph
     */
    public double averageDegree() { return avgDegree; }

    /**
     * Getter for {@link #avgPathLength}
     * @return the average path length of the graph
     */
    public double averagePathLength() { return avgPathLength; }

    /**
     * Getter for {@link #clusteringCoefficient}
     * @return the global clustering coefficient of the graph
     */
    public double clusteringCoefficient() { return clusteringCoefficient; }
