...
public class PercolationStats {
     ...
     */
    public double mean() { return StdStats.mean(x); }

    /**
     * Returns sample standard deviation of percolation threshold
     */
    public double stddev() { return StdStats.stddev(x); }

    /**
     * @return low endpoint of the 95% confidence interval.
     */
    public double confidenceLow() { return mean() - (1.96 * stddev()) / Math.sqrt(m); }

    /**
     * @return high endpoint of the 95% confidence interval
     */
    public double confidenceHigh() { return mean() + (1.96 * stddev()) / Math.sqrt(m); }
